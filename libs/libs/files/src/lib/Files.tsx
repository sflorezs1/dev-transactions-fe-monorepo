...
export const getIconClass = (extension: string): string => {
  switch (extension) {
    ...
    default:
      return 'bi-file-earmark-fill'; // Generic file icon for other extensions
  }
};
...
export const getSubIconClass = (documentType: string): string => {
  switch (documentType) {
    ...
    case 'Rental Agreement':
      return 'bi-file-earmark-richtext-fill';
    case 'Tax Return':
      return 'bi-calculator-fill';
    default:
      return 'bi-file-earmark-fill'; // Generic icon for other types
  }
};
